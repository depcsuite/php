...
if($_POST){
    ...
    //Comprobamos que el usuario sea admin y la clave sea admin123 con pasword verify
    if($usuario == "admin" && password_verify($clave, $claveEncriptada)){
        $_SESSION["nombre"] = "Nelson Daniel";
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="txtUsuario" name="txtUsuario" aria-describedby="emailHelp"
                                                placeholder="Usuario">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="txtClave" name="txtClave" placeholder="Clave">
                                        </div>
                                        <div class="form-group">
